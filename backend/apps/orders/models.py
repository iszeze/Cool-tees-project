...
class Order(models.Model):
    ...
    total_price = models.DecimalField(
        'Total Price', blank = False, null = False, max_digits = 10, decimal_places = 2
    )
    full_name = models.CharField(
        'Full Name', blank = False, null = False, max_length = 50, db_index = True
    )
    address_line1 = models.CharField(
        'Address Line1', blank = False, null = False, max_length = 200, db_index = True
    )
    address_line2 = models.CharField(
        'Address Line2', blank = False, null = False, max_length = 200, db_index = True
    )
    ...
    postal_code = models.IntegerField(
        'Postal Code', blank = True, null = True, db_index = True
    )
    country = models.CharField(
        'Country', blank = False, null = False, max_length = 20, db_index = True, default = 'United States'
    )
